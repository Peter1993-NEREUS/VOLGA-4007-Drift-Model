...
public class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle b) {
        ...
        s.setUserAgentString(s.getUserAgentString()+" MarineDrift-NEREUS/1.6.3 (+https://github.com/Peter1993-NEREUS/VOLGA-4007-Drift-Model)");
        ...
        web.setWebViewClient(new WebViewClient(){
            ...
            @Override public void onPageFinished(WebView view,String url){
                ...
                String js="(function(){"+
                    ...
                    "load('v141loader','v141.js',function(){load('v150loader','v150.js',function(){load('v151loader','v151.js',function(){load('v152loader','v152.js',function(){load('v160loader','v160.js',function(){load('v161loader','v161.js',function(){load('v162loader','v162.js',function(){load('v163loader','v163.js');});});});});});});});"+
                    "})();";
